...
def main() -> None:
    ...
    print(f"Starting SAC Model A training for {args.timesteps} steps.")
    ...
    print(f"\nStarting SAC Model B training for {args.timesteps} steps.")
    ...
    print(f"\nStarting SAC Model C training for {args.timesteps} steps.")
    ...
    evaluate(model_path=f"{save_name_1}.zip", n_episodes=100, deterministic=not args.stochastic, render=args.render, env_type=args.env_type, algo_class=SAC)
    print("\nEvaluation SAC model B.")
    evaluate(model_path=f"{save_name_2}.zip", n_episodes=100, deterministic=not args.stochastic, render=args.render, env_type=args.env_type, algo_class=SAC)
    print("\nEvaluation SAC model C.")
    evaluate(model_path=f"{save_name_3}.zip", n_episodes=100, deterministic=not args.stochastic, render=args.render, env_type=args.env_type, algo_class=SAC)
